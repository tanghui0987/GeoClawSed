...
c ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::;
      ...
      it = int(t/0.002)
      grav = 9.81d0
      !print *, t,it, profile(it+1,1),profile(it+1,2)
...
c     # user-specified boundary conditions go here in place of error output
      ...
      rinvar = 0d0
      do 305 i=1,nrow
        h1 = eta1- aux(1,i,nxl+1)
        u1 = sqrt(grav*(h1))+rinvar
        if (nxl == 1) then
c            # only one ghost cell:
            aux(1,i,1) = aux(1,i,nxl+1)
            val(1,i,1) = h1
            val(2,i,1) = h1*u1
            val(3,i,1) = 0.d0
        else
c            # two ghost cells:
            !print *, h1
            aux(1,i,3) = aux(1,i,nxl+1)
            val(1,i,3) = h1
            val(2,i,3) = h1*u1
            val(3,i,3) = 0.d0

            h2 = eta1 - aux(1,i,nxl+1)
            u2 = 2.d0*sqrt(grav*(h2))+rinvar
            aux(1,i,4) = aux(1,i,nxl+1)
            val(1,i,4) = h2
            val(2,i,4) = h2*u2
            val(3,i,4) = 0.d0
        endif
